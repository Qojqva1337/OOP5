...
public class Main {
    public static void main(String[] args) {
        for (int i = 1; i <= 4; i++) {
            ...
            Bus bus = new Bus("Bus brand №" + i, "Bus brand №" + i, 4.0, driverD);
            Car car = new Car("Car brand №" + i, "Car brand №" + i, 4.5, driverB);
            Truck truck = new Truck("Truck brand №" + i, "Truck brand №" + i, 4.1, driverC);
            printlnfo(car);
            printlnfo(bus);
            printlnfo(truck);
        }
